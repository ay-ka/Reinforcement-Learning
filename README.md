...
<div align="center">
  ...
  <h6 align="center"; display: flex; justify-content: center>Implementation of MADDPG (Multi-Agent Deep Deterministic Policy Gradient) and QMIX (Monotonic 

Value Function Factorisation for Deep Multi-Agent Reinforcement Learning) as well as combining these RL algorithms with EA algorithms (CMAES, CEM, NEAT) & applying to different Benchmark such as Robosuite (Robotic Manipulator Benchmark) </h6>
</div>
...
agents.
  ...
  <li>
    <b><a href="https://nn.cs.utexas.edu/downloads/papers/stanley.cec02.pdf">NEAT (NeuroEvolution of Augmenting Topology)</a>:</b> NEAT (NeuroEvolution 

of                                                                Augmenting Topologies) is an evolutionary algorithm that creates artificial neural networks
  </li>
  <li>
  ...
  <li>
    <b><a href="https://en.wikipedia.org/wiki/CMA-ES">CMA-ES (Covariance Matrix Adaption - Evolutionary Strategies): (PSO)</a>:</b> The  CMA-ES (Covariance                   Matrix Adaptation 

Evolution Strategy) is an evolutionary algorithm for difficult non-linear non-convex black-box optimisation problems in                   continuous domain
  </li>
  <li>
...
<ul>
  ...
  <li>
    <b><a href="https://github.com/uoe-agents/robotic-warehouse">RWARE (Robotic Warehouse; A multi-agent reinforcement learning environment)</a>:</b> The                           multi-robot warehouse (RWARE) environment simulates a warehouse with robots moving 

and delivering requested goods. We based the                             simulator on real-world applications, in which robots pick-up shelves and deliver them to a workstation.
  </li>
  <li>
  ...
  <li>
    <b><a href="https://github.com/uoe-agents/pressureplate">PRESSUREPLATE</a>: </b> PressurePlate is a multi-agent environment that requires agents             to cooperate during the traversal of a 

gridworld. The grid is partitioned into several rooms, and each room contains a plate and a closed                   doorway.
  </li>
</ul>
...
<ul>
  <li>
     <b>ERL_MADDPG:</b> This project is about Implementing <b>MADDPG</b> and combining it with <b>Genetic Algorithm</b> based on method proposed on <a        href="https://arxiv.org/abs/1805.07917">Evolution-Guided Policy Gradient In Reinforcement Learning</a>, apllied on <b>RWARE, MPE, 
...
this section explain instructions which should be followed to setting up the projects. it is easier to run scripts from terminal by passing arguments with the help of argparse library; and this mean of running is followed in all projects in the repository. 

### Prerequisites-Installation

<ul>
  <li>
    Robosuite Instalation: for installing 

Robosuite follow : <a href="https://robosuite.ai/docs/installation.html">Robosuite</a>
  </li>
  <li>
...
<ol type="1">
  <li>for the CEM_MADDPG & CMAES_MADDPG & ERL_MADDPG, the benchmarks tath are available are RWARE, MPE, PressurePlate</li>
  <li>for the ROBOSUITE_MADDPG, the benchmark that is available is Robosuite (when running the codes use 

"RobotManipulator" name) </li>
  <li>for the QMIX_NEAT, the benchmark that is available is RWARE</li>
</ol>

### How To Run


<b>for running: <CEM_MADDPG & CMAES_MADDPG & ERL_MADDPG> </b> 


<h6>on RWARE Benchmark, follow these steps:</h6>

```sh
git clone https://github.com/ay-ka/Reinforcement-Learning.git
cd Reinforcement-Learning
export PYTHONPATH=$PWD
python src/<algorithm-directory-name>/

main.py RWARE --arguments
```

<h6>on PressurePlate Benchmark, follow these steps:</h6>
...
<h6>on MPE Benchmark, follow these steps:</h6>
...
for example for ERL_MADDPG on RWARE Benchmark, follow:
...
for example for CEM_MADDPG on PressurePlate Benchmark, follow:
...
<b>for running <ROBOSUITE_MADDPG></b> 

<h6>on ROBOSUITE Benchmark, follow these steps:</h6>
...
for example for ROBOSUITE_MADDPG on ROBOSUITE Benchmark:
...
for example, for QMIX_NEAT on RWARE Benchmark, follow:
...
<h3><b>Take arguments list: </b></h3> All algorithms take various argument which can be passed through terminal. to get list of all arguments used, insert --help on terminal: <br/><br/>

  
<br/>
  
<b>for taking the list of all arguments used in projects,</b> 

  
<b><h3>for <CEM_MADDPG & CMAES_MADDPG & ERL_MADDPG & ROBOSUITE_MADDPG>, follow these steps:</h3></b>
...
for example for CEM_MADDPG on PressurePlate Benchmark:
...
<b><h3>for <ROBOSUITE_MADDPG> (only Robosuite), follow these steps:</h3></b> 
...
<b><h3>for <QMIX_NEAT (only RWARE)>, follow these steps:</h3></b> 
...
for example for QMIX_NEAT on RWARE Benchmark:
...
```
(for more information about NEAT 

arguments refer to <a href="https://neat-python.readthedocs.io/en/latest/config_file.html">Repo</a>
...
Project Link: [https://github.com/ay-ka/Reinforcement-Learning](https://github.com/ay-ka/Reinforcement-Learning)
...
badge/-LinkedIn-black.svg?style=for-the-badge&logo=linkedin&colorB=555

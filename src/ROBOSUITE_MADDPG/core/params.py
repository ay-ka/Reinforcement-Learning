...
class Parameters:
    def __init__(self, parser):
        ...
        if self.env_name == "RobotManipulator":
            self.agents = len(vars(parser.parse_args())['robots'])
        else:
        ...
        self.task_name = vars(parser.parse_args())['task_name']
        self.robots = vars(parser.parse_args())['robots']
        self.grippers = vars(parser.parse_args())['grippers']
        self.robots_position = vars(parser.parse_args())['robots_position']
        self.control_freq = vars(parser.parse_args())['contro_freq']
        self.reward_shaping = vars(parser.parse_args())['reward_shaping']

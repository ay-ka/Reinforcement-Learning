...
class Parameters:
    def __init__(self, parser):
        ...
        self.min_epsilon = vars(parser.parse_args())['min_epsilon']
        ...
        self.qmix_net_hidden_dim = vars(parser.parse_args())['qmix_net_hidden_dim']
        self.hypernet_hidden_dim = vars(parser.parse_args())['hypernet_hidden_dim']
        self.use_double_q_network = vars(parser.parse_args())['use_double_q_network']

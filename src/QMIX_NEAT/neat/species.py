...
from src.QMIX_NEAT.neat.math_util import mean, stdev
from src.QMIX_NEAT.neat.six_util import iteritems, iterkeys, itervalues
from src.QMIX_NEAT.neat.config import ConfigParameter, DefaultClassConfig
import pdb
...
class Species(object):
    ...
    def get_fitnesses(self):
        lst = []
        for m in itervalues(self.members):
            lst.append(m.fitness)
        return lst

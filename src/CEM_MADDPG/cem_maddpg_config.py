...
def get_config():
        ...
        MPE.add_argument("--initial_epsilon", default="1e-3",  help='small number to add noise in our covariance calculation', type = float)
        
        MPE.add_argument("--epsilon_limit", default="1e-5", help='minimum number epsilon can take (with progressing noise term will decrease)', type = float)
        
        MPE.add_argument("--tau_cem", default="0.95", help='constant for calculating epsilon (noise part in cov calculation) --> (refer to paper)', type = float)
        ...
        RWARE.add_argument("--initial_epsilon", default="1e-3",  help='small number to add noise in our covariance calculation', type = float)
        
        RWARE.add_argument("--epsilon_limit", default="1e-5", help='minimum number epsilon can take (with progressing noise term will decrease)', type = float)
        
        RWARE.add_argument("--tau_cem", default="0.95", help='constant for calculating epsilon (noise part in cov calculation) --> (refer to paper)', type = float)
        ...
        PressurePlate.add_argument("--initial_epsilon", default="1e-3",  help='small number to add noise in our covariance calculation', type = float)
        
        PressurePlate.add_argument("--epsilon_limit", default="1e-5", help='minimum number epsilon can take (with progressing noise term will decrease)', type = float)
        
        PressurePlate.add_argument("--tau_cem", default="0.95", help='constant for calculating epsilon (noise part in cov calculation) --> (refer to paper)', type = float)

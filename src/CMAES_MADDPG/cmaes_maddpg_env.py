...
def MPEEnv(num_agent : int, num_landmark : int, scenario_name = "simple_spread"):
    
        dirc = "/home/shopenhaver-fear/anaconda3/envs/MAPPO/lib/python3.7/site-packages/multiagent/scenarios"

        # load scenario from script
        scenario = load_scenario(dirc, scenario_name + ".py").Scenario()
        
        # create world
        world = scenario.make_world(num_agent, num_landmark)
...
def load_scenario(dirct : str, name : str):
        
        pathname = osp.join(dirct, name)
...
class MultiAgentEnv(gym.Env):
    ...
    def render(self, mode='human', close=False, cam_range = 2):
        if close:
